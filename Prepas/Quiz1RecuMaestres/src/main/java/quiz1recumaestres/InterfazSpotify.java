...
public class InterfazSpotify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        reproducirBucle = new javax.swing.JButton();
        eliminarBucle = new javax.swing.JButton();
        ...
        reproducirBucle.setText("Reproducir en bucle");
        reproducirBucle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                reproducirBucleActionPerformed(evt);
            }
        });
        jPanel1.add(reproducirBucle, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, -1, -1));

        eliminarBucle.setText("Eliminar bucle");
        eliminarBucle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                eliminarBucleActionPerformed(evt);
            }
        });
        jPanel1.add(eliminarBucle, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 370, -1, -1));
    ...
    private void cargarPlaylistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cargarPlaylistActionPerformed
        playlist.agregarCanciones(inputPlaylist.getText());
    ...
    private void reproducirBucleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reproducirBucleActionPerformed
        String mensaje = this.playlist.convertirEnBucle();
        JOptionPane.showMessageDialog(this, mensaje);
    }//GEN-LAST:event_reproducirBucleActionPerformed

    private void eliminarBucleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarBucleActionPerformed
        String mensaje = this.playlist.convertirEnSimple();
        JOptionPane.showMessageDialog(this, mensaje);
    }//GEN-LAST:event_eliminarBucleActionPerformed
    ...
    private javax.swing.JButton eliminarBucle;
    ...
    private javax.swing.JButton reproducirBucle;
